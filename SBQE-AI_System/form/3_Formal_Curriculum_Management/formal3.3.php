...
$marks1 = "";
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='3.3.1' && School_ID ='{$_SESSION['school_id']}' order by Formal_Curriculum_Management_ID desc LIMIT 1 ";
...
$marks2 = "";
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='3.3.2' && School_ID ='{$_SESSION['school_id']}' order by Formal_Curriculum_Management_ID desc  LIMIT 1 ";
$result = $con->query($sql);
...
$marks3 = "";
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='3.3.3' && School_ID ='{$_SESSION['school_id']}' order by Formal_Curriculum_Management_ID desc LIMIT 1 ";
$result = $con->query($sql);
...
$marks4 = "";
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='3.3.4' && School_ID ='{$_SESSION['school_id']}' order by Formal_Curriculum_Management_ID desc LIMIT 1 ";
$result = $con->query($sql);
