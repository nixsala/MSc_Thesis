...
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='3.6.1' && School_ID ='{$_SESSION['school_id']}' order by Formal_Curriculum_Management_ID desc  LIMIT 1 ";
...
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='3.6.2' && School_ID ='{$_SESSION['school_id']}' order by Formal_Curriculum_Management_ID desc  LIMIT 1 ";
$result = $con->query($sql);
