...
$marks1 = "";
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='4.2.1' && School_ID ='{$_SESSION['school_id']}' order by Co_curricular_Activities_ID  desc  LIMIT 1 ";
...
$marks2 = "";
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='4.2.2' && School_ID ='{$_SESSION['school_id']}' order by Co_curricular_Activities_ID  desc LIMIT 1 ";
$result = $con->query($sql);
...
$marks3 = "";
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='4.2.3' && School_ID ='{$_SESSION['school_id']}' order by Co_curricular_Activities_ID  desc LIMIT 1 ";
$result = $con->query($sql);
...
$marks4 = "";
$sql = "SELECT  Marks FROM formal_curriculum_management_main WHERE Activity_Number ='4.2.4' && School_ID ='{$_SESSION['school_id']}' order by Co_curricular_Activities_ID  desc  LIMIT 1 ";
$result = $con->query($sql);
