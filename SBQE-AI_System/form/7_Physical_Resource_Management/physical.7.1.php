...
$marks1 = "";
$sql = "SELECT  Marks FROM physical_resource_management_main WHERE Activity_Number ='7.1.1' && School_ID ='{$_SESSION['school_id']}' order by Physical_Resource_Management_ID desc  LIMIT 1 ";
...
$marks2 = "";
$sql = "SELECT  Marks FROM physical_resource_management_main WHERE Activity_Number ='7.1.2' && School_ID ='{$_SESSION['school_id']}' order by Physical_Resource_Management_ID desc LIMIT 1 ";
$result = $con->query($sql);
...
$marks3 = "";
$sql = "SELECT  Marks FROM physical_resource_management_main WHERE Activity_Number ='7.1.3' && School_ID ='{$_SESSION['school_id']}' order by Physical_Resource_Management_ID desc  LIMIT 1 ";
$result = $con->query($sql);
