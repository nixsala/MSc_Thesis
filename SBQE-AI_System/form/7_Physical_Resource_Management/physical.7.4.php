...
$sql = "SELECT  Marks FROM physical_resource_management_main WHERE Activity_Number ='7.4.1' && School_ID ='{$_SESSION['school_id']}' order by Physical_Resource_Management_ID desc LIMIT 1 ";
...
$sql = "SELECT  Marks FROM physical_resource_management_main WHERE Activity_Number ='7.4.2' && School_ID ='{$_SESSION['school_id']}' order by Physical_Resource_Management_ID desc LIMIT 1 ";
$result = $con->query($sql);
