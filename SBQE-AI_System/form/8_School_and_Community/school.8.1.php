...
$marks1 = "";
$sql = "SELECT  Marks FROM school_community_main WHERE Activity_Number ='8.1.1' && School_ID ='{$_SESSION['school_id']}'  order by School_Community_ID  desc LIMIT 1 ";
...
$marks2 = "";
$sql = "SELECT  Marks FROM school_community_main WHERE Activity_Number ='8.1.2' && School_ID ='{$_SESSION['school_id']}' order by School_Community_ID  desc  LIMIT 1 ";
$result = $con->query($sql);
...
$marks3 = "";
$sql = "SELECT  Marks FROM school_community_main WHERE Activity_Number ='8.1.3' && School_ID ='{$_SESSION['school_id']}' order by School_Community_ID  desc  LIMIT 1 ";
$result = $con->query($sql);
